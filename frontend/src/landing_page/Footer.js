      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <a href="" className="text-muted fs-4"><i class="fab fa-instagram"></i></a>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="" className="text-muted fs-4"><i class="fab fa-facebook"></i></a>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="" className="text-muted fs-4"><i class="fab fa-twitter"></i></a>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="" className="text-muted fs-4"><i class="fab fa-linkedin"></i></a>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="" className="text-muted fs-4"><i class="fab fa-telegram"></i></a>
          </div>
          <div className="col">
            <p>Company</p>
        ...
        <div className="text-center footer-bottom-links">
